...
public class angularOffsetMakerTests {
    ...
    @Test
    public void testSouthAngleMaker() {
        angularOffsetPointsMaker angleMaker = new angularOffsetPointsMaker();
    ...
    public void testNorthEastAngleMaker() {
        ...
        Assert.assertTrue(offsets.contains(new Coordinate(3,-2)));
        ...
        Assert.assertTrue(offsets.contains(new Coordinate(2,-4)));
        Assert.assertTrue(offsets.contains(new Coordinate( 3,-4)));
        Assert.assertTrue(offsets.contains(new Coordinate(4,-4)));
        Assert.assertTrue(offsets.contains(new Coordinate(4,-3)));
        Assert.assertTrue(offsets.contains(new Coordinate(4,-2)));
    }
    @Test
    public void testNorthWestAngleMaker() {
        ...
        Assert.assertTrue(offsets.contains(new Coordinate(-3,1)));
        ...
        Assert.assertTrue(offsets.contains(new Coordinate(-4,2)));
        Assert.assertTrue(offsets.contains(new Coordinate( -4,1)));
        Assert.assertTrue(offsets.contains(new Coordinate(-4,0)));
        Assert.assertTrue(offsets.contains(new Coordinate(-3,-1)));
        Assert.assertTrue(offsets.contains(new Coordinate(-2,-2)));
    }
    @Test
